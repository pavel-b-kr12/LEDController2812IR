...
//    Serial.println(" ");
    ...
    leds[NUM_LEDS/2-i/2+1] = ColorFromPalette(currentPalette, index, indexOrBids%2? sampleavg:(sampleavg*sampleavg/64), NOBLEND);      // With that value, look up the 8 bit colour palette value and assign it to the current LED. 
    leds[NUM_LEDS/2+i/2-1] = ColorFromPalette(currentPalette, index, indexOrBids%2? sampleavg:(sampleavg*sampleavg/64), NOBLEND);      // With that value, look up the 8 bit colour palette value and assign it to the current LED. 
