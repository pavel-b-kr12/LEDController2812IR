...
//case 22:anim_f=randomBlinkRainbow; break;	//not168
//case 23:anim_f=randomBlinkRainbowFade;	effSpeed=99;	effLength=155; break;	//not168
...
case 33:anim_f=rainbowSegments_shift;	effSpeed=2;		effLength=5; break;
case 34:anim_f=rainbowSegments_shift;	effSpeed=2;		effLength=26; break;
//case 35:anim_f=rainbowSegments_shift;	effSpeed=40;	effLength=11; break;
...
case 42:anim_f=juggle;					effSpeed=20;	effLength=32; break;	//:) 	//multiple moving, fade
case 43:anim_f=spawnPixel_moveAll;		effSpeed=55;	effLength=6; break;

case 44:anim_f=fillFadeChangeAll;		effLength=237; break;			//flash over effLength	//not168
case 45:anim_f=fillFadeChangeAll_beat8;	effSpeed=30; effLength=200; break;	//flash over effLength
//case 46:anim_f=fillFadeChangeAll_beatsin8;	effSpeed=20; effLength=22;	break;	//! //flash under effLength // effLength = 22 , so it can change color
case 47:anim_f=fillFadeChangeAll_beatsin8;	effSpeed=20; effLength=127; break;	//flash under effLength

case 48:anim_f=fadeEvenUneven;			effSpeed=25;	effLength=114;	break;	//:) 
case 49:anim_f=fadeEvenUnevenDif;		effSpeed=16;	effLength=30;	break;	//:) 	//effLength is speed

//============================ random
case 50:anim_f=confetti;				effSpeed=45;	effLength=6; break;
//case 51:anim_f=confetti;				effSpeed=178;	effLength=8; break;		//:/	//not168 not328
case 52:anim_f=confetti_move;						effSpeed=45; break;
case 53:anim_f=confetti_moveRemainFirstAdd;			effSpeed=2;		effLength=161; break;
//case 54:anim_f=confetti_moveRemainFirstBlend;		effSpeed=11;	effLength=98; break;	//not168 not328
//case 55:anim_f=confetti_moveRemainFirstBlendByPos;	effSpeed=33;	effLength=240; break;	//not168 not328

//case 56:anim_f=random_burst;			effSpeed=84;	effLength=120; break;	//:/			//not168 not328
//case 57:anim_f=random_color_pop; break;											//:/ //fast 	//not168 not328
...
//case 164:anim_f=palette_pipette;		effFade=129;						break;	//:) //dynamic pallete creator //effFade>128 to edit //not168 not328
//case 165:anim_f=test_palettes;												break;//not168
//case 166:anim_f=test_gradient;												break;//not168
//case 167:anim_f=test_blend;											 		break;//not168
//case 168:anim_f=test_easing;												break;//! //not168 not328
...
//=========================== sample
//case 180:anim_f=blendB;	break;//! //not168 not328
//case 181:anim_f=draw_sample;	effSpeed=13;	effLength=1;	effSpeedH=118;	effLengthH=35;	effFade=1;    indexOrBits=1;	break;//not168 not328
#endif
...
case 200:anim_f=soundmems_H_V;	gDelay=0;	  break; //! need delay >10ms //! fade
case 201:anim_f=soundmems_pal;	currentBlending = LINEARBLEND; gDelay=10;	  break;
case 202:anim_f=soundmems_noise;	currentPalette=OceanColors_p;targetPalette=LavaColors_p; xscale = 30;  yscale = 30;	  break; 
case 203:anim_f=mus_random_mov;	effSpeed=15;	effLength=253;	effSpeedH=9;	effLengthH=16;	effFade=252; gColor=CRGB(255,218,255);indexOrBits=133;gDelay=0; currentPalette=RainbowColors_p; break;
case 204:anim_f=mus_random_mov;	effSpeed=15;	effLength=111;	effSpeedH=9;	effLengthH=16;	effFade=252; gColor=CRGB(255,218,255);indexOrBits=122;gDelay=0; currentPalette=LavaColors_p; break;
case 205:anim_f=soundmems_wave;	 gDelay=0;	effFade=16;	currentPalette = OceanColors_p;    currentBlending = LINEARBLEND;  break;
case 206:anim_f=soundmems_wave;	effSpeed=169;	effLength=122;	effSpeedH=187;	effLengthH=149;	effFade=16;    gColor=CRGB(255,218,255);	indexOrBits=200;	gDelay=0; break;
case 207:anim_f=soundmems_peak_ripple;	effLength=13; gDelay=0;	  break; //step=-1;
