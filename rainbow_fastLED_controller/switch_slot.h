...
case 58: anim_f=matrix;	break;		// random
...
case 101: anim_f=Twinkle;					break; //This sketch demonstrates how to blend between two animations running at the same time.
case 102: anim_f=beatWave;					break; //This animation combines coloured wave values from several beatsin8() functions. See what you can do to mix this one up.
...
case 255: anim_f=ems_lightsALL;				effSpeed=3;		effLength=82;		effDisableChennel=17; break;
